...
interface NewsCategoryDialogProps {
  ...
  onSubmit: (data: NewsCategoryForm) => Promise<void>;
  trigger?: React.ReactNode;
  title?: string;
}

export default function NewsCategoryDialog({
  open,
  onOpenChange,
  category,
  onSubmit,
  trigger,
  title = "News Category",
}: NewsCategoryDialogProps) {
  const form = useForm<NewsCategoryForm>({
  ...
  const handleSubmit = async (data: NewsCategoryForm) => {
    await onSubmit(data);
  };
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Breaking News" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Berita Terkini" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
