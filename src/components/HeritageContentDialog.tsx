...
import {
  heritageContentFormSchema,
  type HeritageContentForm,
} from "@/types/heritage-content-form";
...
interface HeritageContentDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  content: HeritagePageContent | null;
  onSubmit: (data: HeritageContentForm) => Promise<void>;
  trigger?: React.ReactNode;
}

export default function HeritageContentDialog({
  open,
  onOpenChange,
  content,
  onSubmit,
  trigger,
}: HeritageContentDialogProps) {
  const uploadFile = useUploadFile();

  const form = useForm<HeritageContentForm>({
    resolver: zodResolver(heritageContentFormSchema),
    defaultValues: {
      ...
      main_section_title: content?.main_section_title ?? "",
      main_section_title_id: content?.main_section_title_id ?? "",
      main_section_description: content?.main_section_description ?? "",
      main_section_description_id: content?.main_section_description_id ?? "",
  ...
  React.useEffect(() => {
    if (content) {
      ...
      form.reset({
        ...
        subtitle_id: "",
        main_section_title: "",
        main_section_title_id: "",
        main_section_description: "",
        main_section_description_id: "",
        cta_title: "",
        cta_title_id: "",
        cta_description: "",
        cta_description_id: "",
  ...
  const handleSubmit = async (data: HeritageContentForm) => {
    await onSubmit(data);
  };
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
        <DialogHeader>
          <DialogTitle>Edit Heritage Page Content</DialogTitle>
          <DialogDescription>
            Update header, featured, other heritage and CTA sections
          </DialogDescription>
        </DialogHeader>
        <div className="overflow-y-auto flex-1 pr-2">
          <Form {...form}>
            ...
            >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="e.g., Discover Our Heritage"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="e.g., Jelajahi Warisan Kami"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Main hero image for the heritage page
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
              ...
              <div className="space-y-4">
                <div className="space-y-4">
                  <h3 className="text-sm font-medium">Main Heritage Section</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <FormField
                      control={form.control}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <FormField
                      control={form.control}
                      name="main_section_description_id"
                      render={({ field }) => (
                        <FormItem>
